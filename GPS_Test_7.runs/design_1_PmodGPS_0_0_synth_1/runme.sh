...
HD_PWD='F:/Vivado_F/GPS_Test_7/GPS_Test_7.runs/design_1_PmodGPS_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_PmodGPS_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_PmodGPS_0_0.tcl
